const section5SequenceImages = [];
const section7SequenceImages = [];

for (let i = 0; i <= 4; i ++) {
  section5SequenceImages.push(`${`${i}`}.jpg`);
}
for (let i = 0; i <= 101; i ++) {
  section7SequenceImages.push(`${`${i}`}.jpg`);
}
...
const section1Sequence = new ScrollSequence({
  container: '.section1-sequence',
  scrollWith: '.section1-container',
  images: ['img/home/section1.jpg'],
  imagesRoot: '',
  // priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  starts: 'out',
...
const section2Sequence = new ScrollSequence({
  container: '.section2-sequence',
  scrollWith: '.section2-container',
  images: ['img/home/section2.jpg'],
  imagesRoot: '',
  // priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  starts: 'out',
...
const section4Sequence = new ScrollSequence({
  container: '.section4-sequence',
  scrollWith: '.section4-container',
  images: ['img/home/section4.jpg'],
  imagesRoot: '',
  // priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  starts: 'out',
...
const section5Sequence = new ScrollSequence({
  container: '.section5-sequence',
  scrollWith: '.section5-container',
  images: section5SequenceImages,
  imagesRoot: 'img/home/section5/',
  priorityFrames: [0],
  cover: true,
  starts: 'out',
  ends: 'in'
...
const section6Sequence = new ScrollSequence({
  container: '.section6-sequence',
  scrollWith: '.section6-container',
  images: ['img/home/section6.jpg'],
  imagesRoot: '',
  // priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  starts: 'out',
...
const section7Sequence = new ScrollSequence({
  container: '.section7-sequence',
  scrollWith: '.section7-container',
  images: section7SequenceImages,
  imagesRoot: 'img/home/section7/',
  priorityFrames: [0, 20, 40, 60, 80, 100],
  cover: true,
  playUntil: 'scroll-out',
  starts: 'in',
});

const section8Sequence = new ScrollSequence({
  container: '.section8-sequence',
  scrollWith: '.section8-container',
  images: ['img/home/section8.jpg'],
  imagesRoot: '',
  // priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  playUntil: 'scroll-out',
...
const section9Sequence = new ScrollSequence({
  container: '.section9-sequence',
  scrollWith: '.section9-container',
  images: ['img/home/section9.jpg'],
  imagesRoot: '',
  // priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  playUntil: 'scroll-out',
